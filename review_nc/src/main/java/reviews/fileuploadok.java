...
public class fileuploadok extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* [Stream없이 사용하는 방식]
		//getServletContext() : 절대경로사항을 체크사항 (Servlet 에 대한 환경설정 형태)
		//getRealPath("") : 어플리케이션 실제 경로 출력(서버 물리 경로)
		Part filepart = request.getPart("file");	//사용자 PC에 있는 이미지 경로를 임의 저장
		...
		*/
		...
		String savepath = paths + "upload/" + filename;
